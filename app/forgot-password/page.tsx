...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const message = error instanceof AxiosError ? error.response?.data?.message : t("auth.unableToSendResetInstructions")
      setErrorMessage(message || t("auth.unableToSendResetInstructions"))
    }
  }
